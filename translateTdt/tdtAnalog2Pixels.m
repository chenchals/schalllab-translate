...
%EDFANALOG2PIXELS Convert TDT eye data in volts to screenPixels 
%
...
%                  R = (voltage-minvoltage)/(maxvoltage-minvoltage) S =
%                  R*(maxrange-minrange)+minrange  Xgaze =
%                  S*(screenright-screenleft+1)+screenleft 
%
