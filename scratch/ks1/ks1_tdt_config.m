...
ops.fbinary             = '/scratch/subravcr/ksDataProcessed/Rig029/Joule-190702-115514/ks1/Joule-190702-115514.bin'; % will be created for 'openEphys'		
ops.fproc               = '/scratch/subravcr/ksDataProcessed/Rig029/Joule-190702-115514/ks1/temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = '/scratch/subravcr/ksDataProcessed/Rig029/Joule-190702-115514/ks1'; % 'openEphys' only: where raw files are		
...
ops.NT                  = 1024*1024+ ops.ntbuff; %32*1024+ ops.ntbuff;% this is the batch size (try decreasing if out of memory) 		
