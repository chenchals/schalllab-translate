...
if isfield(ops,'recordingSystem') && strcmp('sev',ops.recordingSystem)
...
elseif isfield(ops,'recordingSystem') && strcmp('bin',ops.recordingSystem) && isfield(ops,'dataSessionFile')
...
if strcmp(ops.recordingSystem,'sev') %emouse, tdt
    ...
    ops.headerBytes         = 40;
elseif strcmp(ops.recordingSystem,'bin') %emouse, tdt
     ops.dataAdapter = interface.IDataAdapter.newDataAdapter(ops.recordingSystem,...
