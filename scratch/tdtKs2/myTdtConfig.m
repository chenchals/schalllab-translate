...
% ops.rawDataMultiplier = 1E5; % Ensure raw values are in uV
%%
% Data session / file
...
% 
 ...
 ops.rawDataMultiplier = 1E5; % For TDT simulator values range form -5 - +5 (volts?)...??
%% Channel map file
ops.chanMapPath = fullfile(projectPath,'toolbox/spk-cluster/channelMaps');
ops.chanMapName='linear-probes-1-16-chan-150mu.mat';
